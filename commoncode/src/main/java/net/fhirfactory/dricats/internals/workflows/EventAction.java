...
public class EventAction {
    ...
    public String getActionCreate() {
        return (MESSAGE_ACTION_CREATE);
    }

    public String getActionUpdate() {
        return (MESSAGE_ACTION_UPDATE);
    }

    public String getActionDelete() {
        return (MESSAGE_ACTION_DELETE);
    }

    public String getActionReview() {
        return (MESSAGE_ACTION_REVIEW);
    }

    public String getActionUpdateAdd() {
        return (MESSAGE_ACTION_UPDATE_ADD);
    }

    public String getActionUpdateRemove() {
        return (MESSAGE_ACTION_UPDATE_REMOVE);
    }

    public String getEventActionSystem() {
