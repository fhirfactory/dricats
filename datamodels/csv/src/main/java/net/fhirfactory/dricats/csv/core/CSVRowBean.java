...
import net.fhirfactory.dricats.csv.core.validator.DateValidator;
import net.fhirfactory.dricats.csv.core.validator.ExpectedValuesValidator;
import net.fhirfactory.dricats.csv.core.validator.FieldValidator;
import net.fhirfactory.dricats.csv.core.validator.LengthValidator;
import net.fhirfactory.dricats.csv.core.validator.MandatoryValidator;
import net.fhirfactory.dricats.csv.core.validator.MoneyValidator;
import net.fhirfactory.dricats.csv.core.validator.NumberValidator;
import net.fhirfactory.dricats.csv.core.validator.PropertiesValidator;
import net.fhirfactory.dricats.csv.core.validator.annotation.Date;
import net.fhirfactory.dricats.csv.core.validator.annotation.ExpectedValues;
import net.fhirfactory.dricats.csv.core.validator.annotation.Length;
import net.fhirfactory.dricats.csv.core.validator.annotation.Mandatory;
import net.fhirfactory.dricats.csv.core.validator.annotation.Money;
import net.fhirfactory.dricats.csv.core.validator.annotation.Number;
import net.fhirfactory.dricats.csv.core.validator.annotation.Properties;
            ...
            for (Method method : methods) {
                ...
                for (Class<? extends Annotation> supportedAnnotationClass : supportedAnnotationClasses) {
                    if (method.isAnnotationPresent(supportedAnnotationClass)) {
                        ...
                        } else if (annotation instanceof net.fhirfactory.dricats.csv.core.validator.annotation.Number) {
                            validator = new NumberValidator(fieldName, ((net.fhirfactory.dricats.csv.core.validator.annotation.Number) annotation).type());
